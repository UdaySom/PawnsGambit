...
export interface ApiAchievementAchievement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['tournament', 'milestone', 'special']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCommunityMemberCommunityMember
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1000>;
    socialLinks: Schema.Attribute.JSON;
    totalGames: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chess events, tournaments, workshops';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['tournament', 'workshop', 'meetup', 'online']
    > &
      Schema.Attribute.Required;
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['announcement', 'feature', 'interview']
    > &
      Schema.Attribute.Required;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Organization partners and sponsors';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiPodcastPodcast extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Podcast episodes for Pawn's Gambit";
  ...
  attributes: {
    ...
    artworkAlt: Schema.Attribute.String;
    ...
    listens: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::podcast.podcast'
...
export interface ApiTimelineEventTimelineEvent
  ...
  info: {
    description: 'Historical timeline events for About page';
